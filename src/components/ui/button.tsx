  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-gold text-white font-semibold shadow-gold hover:scale-105 transition-bounce border-2 border-gold/20",
        elegant: "bg-white/10 backdrop-blur-sm text-white border border-white/20 hover:bg-white/20 transition-smooth shadow-soft",
        wedding: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-elegant font-medium",
        gold: "gradient-gold text-white font-semibold shadow-gold hover:shadow-lg transition-smooth",
      },
      size: {
